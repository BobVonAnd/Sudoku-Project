...
public class playSudokuWindow extends Window implements WindowInterface {
    ...
    public void validateInput(int[] selectedField){
        sudokuFront.setNotValidInput(sudokuBoard.getSingleField(selectedField[0], selectedField[1]).getValue() != 
            solvedSudokuBoard.getSingleField(selectedField[0], selectedField[1]).getValue(), selectedField);
